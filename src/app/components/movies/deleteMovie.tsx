...
import deleteMovie from "../../../../utils/movies/deleteMovie";
                ...
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                    <div className="bg-black w-full max-w-[30rem] p-6 rounded-lg shadow-lg relative">
                        ...
                        <div className="flex flex-col w-full items-center gap-2">
                            <p className={`text-xl ${!user && `text-red-600`}`}>{!user ? `You are not authenticated and cannot delete this album!` : `Are you sure you want to delete this movie?`}</p>
